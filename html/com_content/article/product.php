			...
			<div class="tab-content">
			  <div class="tab-pane fade in active" id="product-details">
					<div class="detail-section quick-info">
                        ...
                        <?php
                        $db = JFactory::getDbo();
                        $db->setQuery('SELECT id FROM #__warranty_specs WHERE product='.$this->item->id);
                        if($db->loadResult()){?>
                            <dl>
                                <dt>Compare</dt>
                                <dd><a href="<?php echo JRoute::_('index.php?option=com_warranty&view=compare&id='.$this->item->id, false);?>">So sánh</a></dd>
                            </dl>
                        <?php }?>

                        <dl>
                            <dt>Share</dt>
                            <dd><?php echo $this->item->event->afterDisplayContent; ?></dd>
                        </dl>
					  </div>
					</div>
